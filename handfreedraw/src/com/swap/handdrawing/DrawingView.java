...
public class DrawingView extends View implements OnTouchListener {
	...
	private TouchEventInjection MTouchEventInjectioncb;
	...
	public boolean onTouch(View arg0, MotionEvent event) {
		...
		if(MTouchEventInjectioncb!=null)
			MTouchEventInjectioncb.onTouch(arg0, event);
		return true;
	}
    ...
    public void setTouchEventInjectionCallBack(TouchEventInjection callback){
    	MTouchEventInjectioncb=callback;
    }
